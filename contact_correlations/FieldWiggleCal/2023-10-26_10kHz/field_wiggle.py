...
regex = re.compile('2023-10.*.dat') # this string probably has to be adjusted for each data set
x_name = "freq (MHz)"
y_name = "fraction95"
fit_func = Sinc2
num = 500
...
fn_list = ['2023-10-25_F_e.dat', '2023-10-25_G_e.dat', '2023-10-26_D_e.dat', '2023-10-26_E_e.dat', '2023-10-26_F_e.dat', '2023-10-26_G_e.dat']
time_list = [0,60,20,40,80,100]
