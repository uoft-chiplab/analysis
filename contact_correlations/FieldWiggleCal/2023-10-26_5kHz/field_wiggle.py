...
regex = re.compile('2023-10-26.*.dat') # this string probably has to be adjusted for each data set
x_name = "freq (MHz)"
y_name = "fraction95"
fit_func = Sinc2
num = 500
...
fn_list = ['2023-10-26_H_e.dat', '2023-10-26_I_e.dat', '2023-10-26_J_e.dat', '2023-10-26_K_e.dat', '2023-10-26_L_e.dat', '2023-10-26_M_e.dat',\
	'2023-10-26_O_e.dat', '2023-10-26_Q_e.dat', '2023-10-26_R_e.dat']
time_list = [0,40,80,120,160,200,220,300,340]
time_list = np.array(time_list)  + pulse_length/2.0
