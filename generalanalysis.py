...
def plotlinear(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Linear'):
	"""
...
def plotlorentzian(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Lorentzian'):
	"""
...
def plotsinc(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Sinc'):
	"""
	Inputs: filename, header names - names=['',''], autofind (False is manually inputted path), guess for fit (None is automated guess) [A, x0, sigma, C], residualss (true is have them appear) 
...
def plotsinc2(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Sinc2'):
	"""
	Inputs: filename, header names - names=['',''], autofind (False is manually inputted path), guess for fit (None is automated guess) [A, x0, sigma, C], residualss (true is have them appear) 
...
def plottrapfreq(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='TrapFreq'):
	"""
...
def plottrapfreq2(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='TrapFreq2'):
	"""
...
def plotrabifreq(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='RabiFreq'):
	"""
...
def plotparabola(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Parabola'):
	"""
...
def plotexp(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='Exponential'):
	"""
...
def plotrabiline(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='RabiLine'):
	"""
...
def ploterfc(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='ErfcFit'):
	"""
...
def plotsinpluscos(filename, names=['freq','fraction95'], autofind=True, guess=None, residualss=False, datatype='raw', fit=True, fittype='SinplusCos'):
	"""
