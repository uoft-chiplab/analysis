...
#sys.path.append(r'\\UNOBTAINIUM\E_Carmen_Santiago\Analysis Scripts\Fast-Modulation-Contact-Correlation-Project\contact_correlations')
...
for filename in filenames:
	...
	### save file name
	savefile = os.path.join(proj_path, '/acdimer_lineshape_results_' + spin + '_' + filename + '_.xlsx')
